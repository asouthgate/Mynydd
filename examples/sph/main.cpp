...
int main(int argc, char** argv) {
    ...
    auto compeng = std::make_shared<mynydd::PipelineStep>(
        contextPtr, "examples/sph/shader.comp.spv", 
        std::vector<std::shared_ptr<mynydd::Buffer>>{input, output, uniform}, n
    );
    ...
    mynydd::executeBatch(contextPtr, { compeng });
